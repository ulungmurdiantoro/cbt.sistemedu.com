...
#sidebar-text {
    ...
    /* mPDF supports writing-mode:vertical-rl natively */
    padding-top: 6mm;
    white-space: nowrap;
    overflow: hidden;
}
...
/* ──────────────────────────────────────────
   CONTENT AREA (di antara header dan footer)
   ────────────────────────────────────────── */
.content-area {
    margin-left: 20mm;
    padding: 2mm 10mm 40mm 8mm;
    /* 40mm bottom padding untuk jaga jarak dari footer fixed */
}
