                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        ...
                        <form @submit.prevent="submit">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                />
                                                <div v-if="errors.question" class="text-danger mt-2">
                                                    {{ errors.question }}
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted d-block mt-2">
                                                    Jika dicentang, soal akan ditandai sebagai soal uraian.
                                                </small>

                                                <div v-if="errors.is_essay" class="text-danger mt-2">
                                                    {{ errors.is_essay }}
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small v-if="form.is_essay" class="text-muted d-block mt-2">
                                                    Isi dengan poin-poin jawaban, keyword, atau rubrik penilaian untuk soal uraian.
                                                </small>
                            ...
                            <button type="button" class="btn btn-md btn-warning border-0 shadow" @click="resetForm">
                                Reset
                            </button>
                        </form>
                    </div>
...
export default {
    ...
    setup(props) {
        const form = reactive({
            question: props.essay.question ?? '',
            answer: props.essay.answer ?? '',
            is_essay: props.essay.is_essay ? 1 : 0,
        })

        const submit = () => {
            router.put(`/admin/exams/${props.exam.id}/essays/${props.essay.id}/update`, {
        ...
        const resetForm = () => {
            form.question = props.essay.question ?? ''
            form.answer = props.essay.answer ?? ''
            form.is_essay = props.essay.is_essay ? 1 : 0
        }
