                                ...
                                <tbody v-if="exam.type == 'Essay'">
                                    <tr v-for="(essay, index) in exam.essays.data" :key="index">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button @click.prevent="essayDestroy(exam.id, essay.id)" class="btn btn-sm btn-danger border-0"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                                <tbody v-else>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const destroy = (exam_id, question_id) => {
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        this.$router.delete(`/admin/exams/${exam_id}/questions/${question_id}/destroy`);
            ...
            const essayDestroy = (exam_id, essay_id) => {
                Swal.fire({
                    title: 'Apakah Anda yakin?',
                    text: "Anda tidak akan dapat mengembalikan ini!",
                    icon: 'warning',
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        this.$router.delete(`/admin/exams/${exam_id}/essays/${essay_id}/destroy`);
