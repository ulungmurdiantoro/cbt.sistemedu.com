            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item" :class="{ 'active': $page.url.startsWith('/admin/results') }">
                    ...
                    <span>
                        ...
                        <span class="sidebar-text">Hasil Penilaian</span>
                    </span>
                    </Link>
                </li>
                    ...
                    <span>
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                ...
                                <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.354-5.354 1.25 1.25a.5.5 0 0 1-.708.708l-1.25-1.25a.5.5 0 0 1 .708-.708Zm-2.121 1.414a.5.5 0 0 1 .707 0l1.25 1.25a.5.5 0 0 1-.708.708l-1.25-1.25a.5.5 0 0 1 0-.708Z"/>
                            </svg>
                        </span>
